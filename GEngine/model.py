...
class Mesh:
    ...
    # Change the texture to a new texture
    def change_texture(self, new_texture_path):
        self.texture = self.load_texture(new_texture_path)
    ...
    def load_texture(self, texture_path):
        ...
        # self.im = Image.open(texture_path)
...
class Model:
    ...
    def change_mesh(self, new_mesh_path):
        for mesh in self.meshes:
            mesh.change_texture(new_mesh_path)
